...
**Live:** [https://relaxed-weasel-logto.cloud.nexlayer.ai](https://relaxed-weasel-logto.cloud.nexlayer.ai)  
...
**logto** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/svhd/logto:latest
    path: /
    servicePorts:
    - 3001
    vars:
      DB_URL: "postgresql://logto:${POSTGRES_PASSWORD}@postgres.pod:5432/logto"
      ENDPOINT: "https://relaxed-weasel-logto.cloud.nexlayer.ai"
      ADMIN_ENDPOINT: "https://relaxed-weasel-logto.cloud.nexlayer.ai"
    volumes:
    - name: logto-data
      mountPath: /etc/logto
      size: 5Gi
